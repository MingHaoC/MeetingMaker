...
import com.meetingmaker.component.JwtAuthenticationEntryPoint;
import com.meetingmaker.component.JwtTokenFilter;
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .sessionManagement()
                    ...
                    .and()
                .authorizeRequests()
                    .antMatchers(HttpMethod.POST, "/user/login", "/user/register", "/user/verify/email")
                    .permitAll()
                .anyRequest()
                    .authenticated()
                    .and()
